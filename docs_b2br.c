...
I tried to summrize the concepts needed to understand Born2BeRoot project, as it require more time studying than thinking,
However I do have disclaimer before following what it's written below
